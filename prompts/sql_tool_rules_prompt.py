...
- type (string): Category of the tool (e.g., 'Programming Language', 'Database', 'CRM', 'Sales Software', 'Marketing Tool', 'ERP System', 'Other Software').      - created_at (datetime): Timestamp of when the tool record was created (e.g., '2025-04-02 03:29:12.090996').
    ...
    - 'tools':
      ...
      - type: Specific categories such as 'Programming Language', 'Framework', 'Database', 'Cloud Service', 'DevOps Tool', 'CI/CD Tool', 'CRM', 'Sales Software', 'Accounting Software', 'Marketing Tool', 'Sales Outreach Tool', 'ERP System', or 'Other Software'.
...
When using this tool, you must:
    ...
    - If a specific company, tool, or source is not found in the database, inform the user that no results were found and say that we are adding more data every day and will update them when we have more information.
